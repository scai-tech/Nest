...
from wham.scheduler import Scheduler as ExternalScheduler  # noqa
from wham.op_to_compute import get_compute_unit  # noqa
from wham.op_fusion import node as FusedNode  # noqa
from wham.op_fusion import graph as FusedGraph  # noqa
from wham.op_fusion import graph_bwd as FusedBwdGraph  # noqa
from wham.op_fusion import fusion  # noqa
...
phaze_op_mapping = {
    ...
    "fusedlayernorm": "NativeLayerNorm",
    "add": "Add",
    "sub": "Sub",
    "mul": "Mul", 
    "permute": "Permute",
    ...
    "expand_as": "Expand",
    "repeat": "Expand",
    "repeat_interleave": "Expand",
    "sum": "Sum",
    "log": "Pow",
    # Create Data
    "ones": "MaskedFill",
    "ones_for_fx": "MaskedFill",
    "zeros": "MaskedFill",
    "zeros_for_fx": "MaskedFill",
    "full": "MaskedFill",
    "tensor": "MaskedFill",
    ...
    "ones_like": "MaskedFill",
    "zeros_like": "MaskedFill",
    "one_hot": "MaskedFill",
    "masked_select": "MaskedFill",
    "scatter_": "MaskedFill",
    "scatter": "MaskedFill",
    # Read data
    ...
    "all_to_all": "AllToAll",
    "gather_from_sequence_parallel_region": "AllGather",
    "all_gather_context_parallel": "AllGather",
    "reduce_scatter_to_sequence_parallel_region": "ReduceScatter"
}
