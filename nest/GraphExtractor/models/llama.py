    ...
    def set_model(self):
        ...
        if self.model_name == "llama2":
            ...
            self.tokenizer = AutoTokenizer.from_pretrained(
                "meta-llama/Llama-2-7b-hf", token='', legacy=True) # Set you hf token here
            ...
            self.model = AutoModelForCausalLM.from_config(
               config=config)
            self.tokenizer = AutoTokenizer.from_pretrained(
                "meta-llama/Llama-2-70b-hf", token='', legacy=True) # Set you hf token here
            ...
            self.model = AutoModelForCausalLM.from_config(
               config=config)
            self.tokenizer = AutoTokenizer.from_pretrained(
                "meta-llama/Meta-Llama-3.1-70B", token='', legacy=True) # Set you hf token here
