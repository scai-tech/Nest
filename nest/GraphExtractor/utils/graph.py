...
class PhazeGraph:
    ...
    def __init__(self, tmp_width, model_name, ep_degree, sp_enabled, cp_degree) -> None:
    ...
    def print_graph(self, out_dir, micro_batch_size=1, sequence_length=1):
        ...
        out_file_dot = str(out_dir) + generate_out_filename(self.model_name,
                                                            ...
                                                            ep_degree=self.ep_degree, sp_enabled=self.sp_enabled, cp_degree=self.cp_degree)
