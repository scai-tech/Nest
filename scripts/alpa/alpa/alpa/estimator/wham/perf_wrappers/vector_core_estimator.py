...
def get_performance_est(name, input_shapes, output_shapes, config, energy={}):
    ...
    # Forward Estimation
    stats = get_fwd_estimation(name, input_shapes, output_shapes, config)
    return stats["cycles"]
    ...
    #     if pre_dec_name == "AccumulateGrad":
...
def get_fwd_estimation(name, input_shapes, output_shapes, config, total_cycles=-10):
    # ==================== CudnnBatchNorm, NativeBatchNorm =======================#
    if name == "CudnnBatchNorm" or name == "NativeBatchNorm":
        # y = input * gamma + beta
        # ISA
        # MUL, ADD
        # Cycles = 1
        ...
        gamma = input_shapes[1][0]
        beta = input_shapes[2][0]
    ...
    # ====================== CudnnLayerNorm, NativeBatchNorm =======================#
    elif name == "CudnnLayerNorm" or name == "NativeLayerNorm":
        # y = input * gamma + beta
        # ISA
        # MUL, ADD
        # Cycles = 1
        ...
        gamma = int(input_shapes[0][-1])
        beta = int(input_shapes[1][-1])
    ...
    # ====================== Tanh, Hardtanh =======================#
    elif name == "Tanh" or name == "Hardtanh":
        # y = tanh(x)
        # y = hardtanh(x)
    ...
    # ====================== Hardsigmoid, Sigmoid =======================#
    elif name == "Hardsigmoid" or name == "Sigmoid":
        # y = Sigmoid(x)
    ...
    # ====================== Hardswish, Swiss =======================#
    elif name == "Swiss" or name == "Hardswish":
        # y = Swiss(x)
    ...
    elif name == "MaxPool2DWithIndices":
    ...
    elif name == "NativeDropout" or name == "FusedDropout":
        # y = x * (1/1-p)
        # ISA
        # RAND, COMP, ADD, MUL
...
def get_bwd_estimation(schd, node, config, total_cycles=-10):
    ...
    # ====================== Silu =======================#
        ...
        # dy/dx = σ(x)*(1+x*(1−σ(x))) # σ(x) = SIGMOID
    ...
    # ====================== MaxPool2DWithIndices =======================#
    elif name == "MaxPool2DWithIndices" or name == "AvgPool2D":
        # dy/dx = x
        # Cycles = 1
        PE_cycles = 1
...
def get_weight_update_estimation(name, input_shapes, output_shapes, num_weights, config):
