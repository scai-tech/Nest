...
def _call_solver_serialized_args(N,
    ...
    def get_non_zero_index(binary_vector):
        ...
        if ct == 1:
            ...
            print(f"Debug: Multiple solutions found, this is the issue causing assertion failure")
            return ret  # Return the last found index
        else:
            print(f"Debug: No solutions found, returning 0")
            return 0
