"""
Distributed Llama2 Training with Alpa (Pipeshard Parallelism + Estimator Mode)
===============================================================================
...
Example:
    python script.py --num_nodes 32 --num_layers 16 --num_microbatch 512
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Alpa Llama2 training with estimator mode.")
    parser.add_argument("--num_nodes",      type=int, default=32,  help="Number of nodes in the fake cluster.")
    parser.add_argument("--num_layers",     type=int, default=16,  help="Number of hidden layers in Llama2.")
...
def main():
    ...
    config = AutoConfig.from_pretrained(
        MODEL_NAME,
        token='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', ## Note: replace Take out token 
