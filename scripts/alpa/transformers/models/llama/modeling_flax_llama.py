...
class FlaxLlamaAttention(nn.Module):
    ...
    def __call__(
        ...
        # key, query = self.rotary_emb(key, query, position_ids) # NEST Remove for sharding
...
class FlaxLlamaModule(nn.Module):
    ...
    def __call__(
        ...
        # # MODIFICATION: Create dummy embeddings instead of using gather operation
        # batch_size, seq_len = input_ids.shape
        
        # # Option 1: Random embeddings (for testing/research)
