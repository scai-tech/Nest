...
# TODO: changes made for Phaze; created the class for torch.fx
...
class BertModel(LanguageModule):
    ...
    def __init__(
        ...
        # TODO: added the self.arange object Phaze
    ...
    def bert_position_ids(self, token_ids, arange_fnc):
        # Create position ids
        seq_length = token_ids.size(1)
        # TODO: change made for Phaze; change from torch.arange to arange_fnc
    ...
    def forward(
        ...
        if parallel_state.is_pipeline_first_stage():
            ...
            # TODO: changes made for Phaze; added the self.arange
            position_ids = self.bert_position_ids(input_ids, self.arange)
        else:
            position_ids = None
            input_ids = None
