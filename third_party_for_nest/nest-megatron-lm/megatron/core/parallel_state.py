...
def create_group(
    ...
    # TODO; change for phaze, manually setting the rank
    # TODO: change for Phaze to ensure torch.distributed is not invoked and setting group manually
    ranks = 0 
...
def initialize_model_parallel(
    ...
    world_size: int = tensor_model_parallel_size * expert_model_parallel_size
    # TODO change for Phaze
...
def get_tensor_model_parallel_world_size():
    ...
    # TODO; change for phaze; cannot get world size from torch distributed
...
def get_tensor_model_parallel_rank():
    ...
    # TODO: change for phaze; get_tensor_model_parallel_rank = 0, as only single gpu run is traced
