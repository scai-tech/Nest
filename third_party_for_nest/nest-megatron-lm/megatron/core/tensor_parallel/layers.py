...
class VocabParallelEmbedding(torch.nn.Module):
    ...
    def forward(self, input_):
        ...
        if self.tensor_model_parallel_size > 1:
            ...
            # TODO: change for phaze, masked input cannot be assigned during tracing
        ...
        # TODO: change for phaze, we cannot assign variables during tracing
        # if self.tensor_model_parallel_size > 1:
...
class LinearWithGradAccumulationAndAsyncCommunication(torch.autograd.Function):
    ...
    def forward(
        ...
        if sequence_parallel:
            ...
            total_input = gather_from_sequence_parallel_region(input, world_size)
        else:
            total_input = input
...
class ColumnParallelLinear(torch.nn.Module):
    ...
    def forward(
        ...
        if weight is None:
            ...
            # if weight.shape != expected_shape: ##NEST
            #     raise RuntimeError(
        ...
        #TODO: Phaze, cannot use control flow during tracing. Gather output is defaulted to false
        output = output_parallel
...
class RowParallelLinear(torch.nn.Module):
    ...
    def forward(self, input_):
        ...
        # Matrix multiply.
        #TODO: Phaze remove control flow (requires grad)
