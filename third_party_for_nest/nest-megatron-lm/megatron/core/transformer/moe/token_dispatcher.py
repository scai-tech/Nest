...
# TODO: for phaze, to track the allto all
...
class MoEAllGatherTokenDispatcher(MoETokenDispatcher):
    ...
    def __init__(
        self, num_local_experts: int, local_expert_indices: List[int], config: TransformerConfig, arange_module:torch.nn.Module=torch.arange
    ) -> None:
        """
        ...
        #TODO: Phaze add custom arange function for tracing
        self.arange_module = arange_module
        ...
        if self.num_local_experts > 1:
            if self.drop_and_pad:
                ...
                global_input_tokens = sort_chunks_by_idxs(
                    global_input_tokens,
                    self.num_global_tokens_per_local_expert.reshape(-1),
