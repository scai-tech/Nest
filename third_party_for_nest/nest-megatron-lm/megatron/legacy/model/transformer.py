...
# TODO: changes for phaze, added the import of function
...
# TODO: For phaze, adding the following class
...
# TODO: For phaze, adding the torch.fx wrap function
...
class CoreAttention(MegatronModule):
    ...
    def __init__(self, layer_number, config,
        ...
        # TODO: change for phaze, adding the empty for fx function
    ...
    def forward(self, query_layer, key_layer,
        ...
        # TODO: change for phaze, creating a dummy torch.fx.wrap function around
        ...
        context_layer = context_layer.view(*output_size)
         # TODO: change for phaze; changing the view to accept the layer shape manually
...
class ParallelAttention(MegatronModule):
    ...
    def forward(self, hidden_states, attention_mask,
        ...
        if self.attention_type == AttnType.self_attn:
            ...
            # TODO: change for phaze, unrolling the new_tensor_shape instead of *new_tensor_shape
...
# TODO: change for phaze, commented the decorator for tracing
# @jit_fuser
...
class ParallelTransformerLayer(MegatronModule):
    ...
    def default_decoder_cross_attention(self,
        ...
        with self.bias_dropout_add_exec_handler():
            # TODO: change for phaze, bias_dropout_add_func passes through control flow
            norm_input = bias_dropout_add_fused_train(
                attention_output,
    ...
    def forward(self, hidden_states, attention_mask,
        ...
        if self.drop_path is None:
            ...
            #                                          keep_graph = True)
            # TODO:change for phaze; function is directly used as it is wrapped in torch.fx instead of core.utils.make_viewless_tensor
...
class ParallelTransformer(MegatronModule):
    ...
    def forward(self, hidden_states, attention_mask,
        ...
        # TODO: phaze change; directly invoking the make viewless tensor instead from core.utils.make_viewless_tensor
